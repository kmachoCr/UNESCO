  ...
  slides: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          isCorrect: true,
          feedback: 'El agua es un elemento natural e inerte.',
        ...
        },
        {
          ...
          isCorrect: false,
          feedback: 'Los árboles están vivos por lo que reaccionan, por ejemplo, sus raíces crecen hacia donde pueden encontrar agua.',
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          isCorrect: false,
          feedback: '¡No! El suelo es natural, tiene muchas condiciones que hacen posible la vida, pero en sí mismo no es un ser vivo.',
      ...
      options: [
        {
          ...
          isCorrect: true,
          feedback: '¡Muy bien! El mono es un ser vivo por lo que respira. Incluso, es pariente de los seres humanos.',
        ...
        },
        {
          ...
          isCorrect: false,
          feedback: '¡Oh, oh! Si respirara estaría viva y las rocas son inertes.',
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback: '¡Oh, oh! El Sol no es un ser vivo. Aunque sí ayuda al crecimiento de plantas y a la vida en la Tierra.',
        ...
        },
        {
          ...
          isCorrect: false,
          feedback: 'Los lápices son seres inertes, o sea, no tienen vida.',
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          image: '../images/lab1/lab01-icon-cerca.svg',
          isCorrect: true,
          feedback: '¡Muy bien! Las cercas de madera no tienen vida y son construidas por las personas.',
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          isCorrect: false,
          feedback: 'Sí podemos ver lapas en el cielo mientras vuelan, pero son aves por lo tanto son seres vivos. ',
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          image: '../images/lab1/lab01-icon-delfin.svg',
          isCorrect: false,
          feedback: 'Los delfines son mamíferos por lo que nacen directamente de sus madres.',
        ...
        },
        {
          ...
          image: '../images/lab1/lab01-icon-piedra.svg',
          isCorrect: false,
          feedback: '¡Oh, oh! Para reproducirse debería tener vida y las rocas son inertes.',
